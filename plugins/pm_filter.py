...
async def pm_text(bot, message):
    ...
    await message.reply_text("<b>ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴀɴᴅ sᴇᴀʀᴄʜ ᴍᴏᴠɪᴇ ɪɴ ᴛʜᴇ ɢʀᴏᴜᴘ  📌 https://t.me/+-VlJFDkAQ4cyMjU1 📌             ᴀᴅᴍɪɴ 😎 -  @Anand_2K          Enter Movie Name In This Bot - @MASK_KP_2k21_bot</b>")
